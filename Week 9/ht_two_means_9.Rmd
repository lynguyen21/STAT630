...
Conclusion: We do not have enough evidence that the difference in average income for people in CA is greater than the income for people in Ohio.
...
```{r}
memory <- read.csv("~/Documents/Personal Docs_East Bay/STAT 630/Week 9/islander_data.csv") #memory: denote name of the dataset


```

After being primed with sad memories, does anti-anxiety medication **positively affect** memory (mu_d > 0)
...
Conclusion: We have enough evidence that the true mean of the differences in memory score(after - before being primed with sad )
