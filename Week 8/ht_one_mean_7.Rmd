...
t_dist_5 <- dt(x, df = 5) #calculates the probability density function (PDF) of a t-distribution
t_dist_10 <- dt(x, df = 10)
t_dist_30 <- dt(x, df = 30)
z_dist <- dnorm(x) #calculates the probability density function (PDF) of the normal distribution.
