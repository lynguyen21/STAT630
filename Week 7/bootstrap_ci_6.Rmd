...
# ci_high <- phat + qnorm(0.975)*sqrt(phat*(1-phat)/n)
```
...
phats <- rbinom(n_samp, n_1, p) / n_1

ci_low  <- phats - qnorm(0.975) * sqrt(phats*(1 - phats) / n_1)
ci_high <- phats + qnorm(0.975) * sqrt(phats*(1 - phats) / n_1)
